...
10. [Варианты заданий к лабораторной работе](#10-варианты-заданий-к-лабораторной-работе)
    ...
    - [Вариант 1. Корпоративный FAQ-бот](#вариант-1-корпоративный-faq-бот)
    - [Вариант 2. Техническая документация Python](#вариант-2-техническая-документация-python)
    - [Вариант 3. Медицинские протоколы (на русском языке)](#вариант-3-медицинские-протоколы-на-русском-языке)
    - [Вариант 4. Юридические документы и законы](#вариант-4-юридические-документы-и-законы)
    - [Вариант 5. Научные статьи (arXiv)](#вариант-5-научные-статьи-arxiv)
    - [Вариант 6. Многоязычный датасет (EN/RU/DE)](#вариант-6-многоязычный-датасет-enru-de)
    - [Вариант 7. Учебно-методическая документация (слайды лекций)](#вариант-7-учебно-методическая-документация-слайды-лекций)
    - [Вариант 8. API-документация (FastAPI, Django)](#вариант-8-api-документация-fastapi-django)
    - [Вариант 9. Логи и баги (техподдержка)](#вариант-9-логи-и-баги-техподдержка)
    - [Вариант 10. Отзывы пользователей и рекомендации](#вариант-10-отзывы-пользователей-и-рекомендации)
